...
SECRET_KEY = 'django-insecure-2(b*$rsew1f9wt8@d%ec1(t^&05hs927_npbb0)@%t-)g)eisy'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DB_NAME', 'transportation'),
...
MASTODON_PUPPY_EMAIL = os.environ.get("MASTODON_LOGIN_EMAIL", 'bencarneiro@gmail.com+1')
