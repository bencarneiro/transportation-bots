...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        expense_facilities[['UZA', 'UZA Area SQ Miles', 'UZA Population', 'NTD ID']] = expense_facilities[['UZA', 'UZA Area SQ Miles', 'UZA Population', 'NTD ID']].fillna(0)
        for x in expense_facilities.index: 
            ...
            for year in years:
                new_transit_expense = TransitExpense(
                    ...
                    mode_id = expense_facilities['Mode'][x],
                    service_id = "DO",
                    year_id = int(year),
                    expense_type_id = "FC",
