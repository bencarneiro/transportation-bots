...
function OtherPerformance(props) {
  ...
  React.useEffect(() => {
    if (props.params) {
      axios.get(`http://45.33.31.186/cost_per_upt/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setCostPerUpt(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_pmt/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setCostPerPmt(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrh/?mode=OT,AT,FB,nan${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrm/?mode=OT,AT,FB,nan${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/frr/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setFrr(response.data.data))
      axios.get(`http://45.33.31.186/vrm_per_vrh/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setVrmPerVrh(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrh/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setUptPerVrh(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrm/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setUptPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrh/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setPmtPerVrh(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrm/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setPmtPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_upt_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setCostPerUptBymode(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_pmt_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setCostPerPmtBymode(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrh_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrm_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/frr_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setFrrBymode(response.data.data))
      axios.get(`http://45.33.31.186/vrm_per_vrh_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setVrmPerVrhBymode(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrh_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setUptPerVrhBymode(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrm_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setUptPerVrmBymode(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrh_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setPmtPerVrhBymode(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrm_by_mode/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setPmtPerVrmBymode(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_upt_by_service/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setCostPerUptByService(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_pmt_by_service/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setCostPerPmtByService(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrh_by_service/?mode=OT,AT,FB,nan${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrm_by_service/?mode=OT,AT,FB,nan${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/frr_by_service/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setFrrByService(response.data.data))
      axios.get(`http://45.33.31.186/vrm_per_vrh_by_service/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setVrmPerVrhByService(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrh_by_service/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setUptPerVrhByService(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrm_by_service/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setUptPerVrmByService(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrh_by_service/?mode=OT,AT,FB,nan${props.params}`)
      .then(response => setPmtPerVrhByService(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrm_by_service/?mode=OT,AT,FB,nan${props.params}`)
