...
function AllService(props) {
    ...
    if (props.params) {
        axios.get(`http://localhost:8000/upt/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setUpt(response.data.data));
        axios.get(`http://localhost:8000/pmt/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setPmt(response.data.data));
        axios.get(`http://localhost:8000/vrh/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrh(response.data.data));
        axios.get(`http://localhost:8000/vrm/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrm(response.data.data));
        axios.get(`http://localhost:8000/voms/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVoms(response.data.data));
        axios.get(`http://localhost:8000/drm/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setDrm(response.data.data));
        axios.get(`http://localhost:8000/upt_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setUptByMode(response.data.data))
        axios.get(`http://localhost:8000/pmt_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setPmtByMode(response.data.data))
        axios.get(`http://localhost:8000/vrm_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrmByMode(response.data.data))
        axios.get(`http://localhost:8000/vrh_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrhByMode(response.data.data))
        axios.get(`http://localhost:8000/voms_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVomsByMode(response.data.data))
        axios.get(`http://localhost:8000/drm_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setDrmByMode(response.data.data))
        axios.get(`http://localhost:8000/upt_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setUptByService(response.data.data))
        axios.get(`http://localhost:8000/pmt_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setPmtByService(response.data.data))
        axios.get(`http://localhost:8000/vrh_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrhByService(response.data.data))
        axios.get(`http://localhost:8000/vrm_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrmByService(response.data.data))
        axios.get(`http://localhost:8000/voms_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVomsByService(response.data.data))
        axios.get(`http://localhost:8000/drm_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
