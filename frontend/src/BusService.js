...
function AllService(props) {
    ...
    if (props.params) {
        axios.get(`/upt/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setUpt(response.data.data));
        axios.get(`/pmt/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setPmt(response.data.data));
        axios.get(`/vrh/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrh(response.data.data));
        axios.get(`/vrm/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrm(response.data.data));
        axios.get(`/voms/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVoms(response.data.data));
        axios.get(`/drm/?mode=MB,CB,RB,TB,PB${props.params}`)
        ...
        axios.get(`/vrm_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrmByMode(response.data.data))
        axios.get(`/vrh_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrhByMode(response.data.data))
        axios.get(`/voms_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVomsByMode(response.data.data))
        axios.get(`/drm_by_mode/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setDrmByMode(response.data.data))
        axios.get(`/upt_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setUptByService(response.data.data))
        axios.get(`/pmt_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setPmtByService(response.data.data))
        axios.get(`/vrh_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrhByService(response.data.data))
        axios.get(`/vrm_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVrmByService(response.data.data))
        axios.get(`/voms_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
        .then(response => setVomsByService(response.data.data))
        axios.get(`/drm_by_service/?mode=MB,CB,RB,TB,PB${props.params}`)
