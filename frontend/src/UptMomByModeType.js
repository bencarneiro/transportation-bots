    ...
    return (
      <div className="custom-tooltip" style={{ backgroundColor: "white", fontSize: "16px", margin: "10px" }}>
        ...
        {payload[0].payload.bus > 0 && (
          ...
          }).format(payload[0].payload.bus * 100)}%`}</p>
        )}
...
export default UptMomByModeType