...
function AllService(props) {
    ...
    if (props.params) {
        axios.get(`http://localhost:8000/upt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setUpt(response.data.data));
        axios.get(`http://localhost:8000/pmt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setPmt(response.data.data));
        axios.get(`http://localhost:8000/vrh/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrh(response.data.data));
        axios.get(`http://localhost:8000/vrm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrm(response.data.data));
        axios.get(`http://localhost:8000/voms/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVoms(response.data.data));
        axios.get(`http://localhost:8000/drm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        ...
        axios.get(`http://localhost:8000/vrm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrmByMode(response.data.data))
        axios.get(`http://localhost:8000/vrh_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrhByMode(response.data.data))
        axios.get(`http://localhost:8000/voms_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVomsByMode(response.data.data))
        axios.get(`http://localhost:8000/drm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setDrmByMode(response.data.data))
        axios.get(`http://localhost:8000/upt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setUptByService(response.data.data))
        axios.get(`http://localhost:8000/pmt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setPmtByService(response.data.data))
        axios.get(`http://localhost:8000/vrh_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrhByService(response.data.data))
        axios.get(`http://localhost:8000/vrm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrmByService(response.data.data))
        axios.get(`http://localhost:8000/voms_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVomsByService(response.data.data))
        axios.get(`http://localhost:8000/drm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
  ...
  return (
    ...
    <h1>Passenger Trips</h1>
        <Upt chartData={upt}/>
        <RailUptByMode chartData={uptByMode}/>
        <UptByService chartData={uptByService}/>

        <br/><br/>
        <h1>Passenger Miles</h1>
        <Pmt chartData={pmt}/>
        <RailUptByMode chartData={pmtByMode}/>
        <UptByService chartData={pmtByService}/>
        <br/><br/>

        <h1>Vehicle Miles</h1>
        <Vrm chartData={vrm}/>
        <RailUptByMode chartData={vrmByMode}/>
        ...
        <Drm chartData={drm}/>
        <RailUptByMode chartData={drmByMode}/>
