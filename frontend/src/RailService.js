...
import Vrm from "./Vrm"
import Vrh from "./Vrh"
import RailUptByMode from "./RailUptByMode"
...
function AllService(props) {
    ...
    if (props.params) {
        axios.get(`http://45.33.31.186/upt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setUpt(response.data.data));
        axios.get(`http://45.33.31.186/pmt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setPmt(response.data.data));
        axios.get(`http://45.33.31.186/vrh/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrh(response.data.data));
        axios.get(`http://45.33.31.186/vrm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrm(response.data.data));
        axios.get(`http://45.33.31.186/voms/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVoms(response.data.data));
        axios.get(`http://45.33.31.186/drm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        ...
        axios.get(`http://45.33.31.186/vrm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrmByMode(response.data.data))
        axios.get(`http://45.33.31.186/vrh_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrhByMode(response.data.data))
        axios.get(`http://45.33.31.186/voms_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVomsByMode(response.data.data))
        axios.get(`http://45.33.31.186/drm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setDrmByMode(response.data.data))
        axios.get(`http://45.33.31.186/upt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setUptByService(response.data.data))
        axios.get(`http://45.33.31.186/pmt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setPmtByService(response.data.data))
        axios.get(`http://45.33.31.186/vrh_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrhByService(response.data.data))
        axios.get(`http://45.33.31.186/vrm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrmByService(response.data.data))
        axios.get(`http://45.33.31.186/voms_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVomsByService(response.data.data))
        axios.get(`http://45.33.31.186/drm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
  ...
  return (
    ...
    <h1>Passenger Trips</h1>
        ...
        <RailUptByMode chartData={uptByMode} axisLabel={"Unlinked Passenger Trips"}/>
        ...
        <RailUptByMode chartData={pmtByMode} axisLabel={"Passenger Miles Travled"}/>
        <UptByService chartData={pmtByService} axisLabel={"Passenger Miles Travled"}/>
        <br/><br/>

        <h1>Vehicle Miles</h1>
        <Vrm chartData={vrm} axisLabel={"Vehicle Revenue Miles"}/>
        <RailUptByMode chartData={vrmByMode} axisLabel={"Vehicle Revenue Miles"}/>
        ...
        <RailUptByMode chartData={vrhByMode} axisLabel={"Vehicle Revenue Hours"}/>
        ...
        <RailUptByMode chartData={vomsByMode} axisLabel={"Vehicles at Max Service"}/>
        ...
        <RailUptByMode chartData={drmByMode} axisLabel={"Directional Route Miles"}/>
