...
function AllService(props) {
    ...
    if (props.params) {
        axios.get(`/upt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setUpt(response.data.data));
        axios.get(`/pmt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setPmt(response.data.data));
        axios.get(`/vrh/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrh(response.data.data));
        axios.get(`/vrm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrm(response.data.data));
        axios.get(`/voms/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVoms(response.data.data));
        axios.get(`/drm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setDrm(response.data.data));
        axios.get(`/upt_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setUptByMode(response.data.data))
        axios.get(`/pmt_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setPmtByMode(response.data.data))
        axios.get(`/vrm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrmByMode(response.data.data))
        axios.get(`/vrh_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrhByMode(response.data.data))
        axios.get(`/voms_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVomsByMode(response.data.data))
        axios.get(`/drm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setDrmByMode(response.data.data))
        axios.get(`/upt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setUptByService(response.data.data))
        axios.get(`/pmt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setPmtByService(response.data.data))
        axios.get(`/vrh_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrhByService(response.data.data))
        axios.get(`/vrm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVrmByService(response.data.data))
        axios.get(`/voms_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
        .then(response => setVomsByService(response.data.data))
        axios.get(`/drm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
