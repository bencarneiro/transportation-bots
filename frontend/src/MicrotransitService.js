...
function AllService(props) {
    ...
    if (props.params) {
        axios.get(`http://localhost:8000/upt/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setUpt(response.data.data));
        axios.get(`http://localhost:8000/pmt/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setPmt(response.data.data));
        axios.get(`http://localhost:8000/vrh/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrh(response.data.data));
        axios.get(`http://localhost:8000/vrm/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrm(response.data.data));
        axios.get(`http://localhost:8000/voms/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVoms(response.data.data));
        axios.get(`http://localhost:8000/drm/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setDrm(response.data.data));
        axios.get(`http://localhost:8000/upt_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setUptByMode(response.data.data))
        axios.get(`http://localhost:8000/pmt_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setPmtByMode(response.data.data))
        axios.get(`http://localhost:8000/vrm_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrmByMode(response.data.data))
        axios.get(`http://localhost:8000/vrh_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrhByMode(response.data.data))
        axios.get(`http://localhost:8000/voms_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVomsByMode(response.data.data))
        axios.get(`http://localhost:8000/drm_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setDrmByMode(response.data.data))
        axios.get(`http://localhost:8000/upt_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setUptByService(response.data.data))
        axios.get(`http://localhost:8000/pmt_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setPmtByService(response.data.data))
        axios.get(`http://localhost:8000/vrh_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrhByService(response.data.data))
        axios.get(`http://localhost:8000/vrm_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrmByService(response.data.data))
        axios.get(`http://localhost:8000/voms_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVomsByService(response.data.data))
        axios.get(`http://localhost:8000/drm_by_service/?mode=DT,DR,VP,JT${props.params}`)
  ...
  return (
    ...
    <h1>Passenger Trips</h1>
        <Upt chartData={upt}/>
        <MicrotransitUptByMode chartData={uptByMode}/>
        <UptByService chartData={uptByService}/>

        <br/><br/>
        <h1>Passenger Miles</h1>
        <Pmt chartData={pmt}/>
        <MicrotransitUptByMode chartData={pmtByMode}/>
        <UptByService chartData={pmtByService}/>
        <br/><br/>

        <h1>Vehicle Miles</h1>
        <Vrm chartData={vrm}/>
        <MicrotransitUptByMode chartData={vrmByMode}/>
        ...
        <h1>Vehicle Hours</h1>
        <Vrh chartData={vrh}/>
        <MicrotransitUptByMode chartData={vrhByMode}/>
        <UptByService chartData={vrhByService}/>
        <br/><br/>

        <h1>Vehicles Operated in Maximum Service</h1>
        <Voms chartData={voms}/>
        <MicrotransitUptByMode chartData={vomsByMode}/>
        ...
        <Drm chartData={drm}/>
        <MicrotransitUptByMode chartData={drmByMode}/>
