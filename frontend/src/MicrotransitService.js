...
function AllService(props) {
    ...
    if (props.params) {
        axios.get(`http://45.33.31.186/upt/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setUpt(response.data.data));
        axios.get(`http://45.33.31.186/pmt/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setPmt(response.data.data));
        axios.get(`http://45.33.31.186/vrh/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrh(response.data.data));
        axios.get(`http://45.33.31.186/vrm/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrm(response.data.data));
        axios.get(`http://45.33.31.186/voms/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVoms(response.data.data));
        axios.get(`http://45.33.31.186/drm/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setDrm(response.data.data));
        axios.get(`http://45.33.31.186/upt_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setUptByMode(response.data.data))
        axios.get(`http://45.33.31.186/pmt_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setPmtByMode(response.data.data))
        axios.get(`http://45.33.31.186/vrm_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrmByMode(response.data.data))
        axios.get(`http://45.33.31.186/vrh_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrhByMode(response.data.data))
        axios.get(`http://45.33.31.186/voms_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVomsByMode(response.data.data))
        axios.get(`http://45.33.31.186/drm_by_mode/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setDrmByMode(response.data.data))
        axios.get(`http://45.33.31.186/upt_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setUptByService(response.data.data))
        axios.get(`http://45.33.31.186/pmt_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setPmtByService(response.data.data))
        axios.get(`http://45.33.31.186/vrh_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrhByService(response.data.data))
        axios.get(`http://45.33.31.186/vrm_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVrmByService(response.data.data))
        axios.get(`http://45.33.31.186/voms_by_service/?mode=DT,DR,VP,JT${props.params}`)
        .then(response => setVomsByService(response.data.data))
        axios.get(`http://45.33.31.186/drm_by_service/?mode=DT,DR,VP,JT${props.params}`)
