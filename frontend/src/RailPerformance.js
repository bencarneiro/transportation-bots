...
function AllPerformance(props) {
  ...
  React.useEffect(() => {
    if (props.params) {
      axios.get(`http://45.33.31.186/cost_per_upt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setCostPerUpt(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_pmt/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setCostPerPmt(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrh/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/frr/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setFrr(response.data.data))
      axios.get(`http://45.33.31.186/vrm_per_vrh/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setVrmPerVrh(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrh/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setUptPerVrh(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setUptPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrh/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setPmtPerVrh(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrm/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      ...
      // axios.get(`http://45.33.31.186/cost_per_vrh_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/frr_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setFrrBymode(response.data.data))
      axios.get(`http://45.33.31.186/vrm_per_vrh_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setVrmPerVrhBymode(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrh_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setUptPerVrhBymode(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setUptPerVrmBymode(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrh_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setPmtPerVrhBymode(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrm_by_mode/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setPmtPerVrmBymode(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_upt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setCostPerUptByService(response.data.data))
      axios.get(`http://45.33.31.186/cost_per_pmt_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setCostPerPmtByService(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrh_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`http://45.33.31.186/cost_per_vrm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`http://45.33.31.186/frr_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setFrrByService(response.data.data))
      axios.get(`http://45.33.31.186/vrm_per_vrh_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setVrmPerVrhByService(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrh_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setUptPerVrhByService(response.data.data))
      axios.get(`http://45.33.31.186/upt_per_vrm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setUptPerVrmByService(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrh_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
      .then(response => setPmtPerVrhByService(response.data.data))
      axios.get(`http://45.33.31.186/pmt_per_vrm_by_service/?mode=LR,CR,HR,YR,SR,OR,MG,AR,IP,CC${props.params}`)
  ...
  return (
    <div className="App">
        ...
        <RailPerformanceByMode chartData={frrBymode} axisLabel={"% of Expenses Recovered"}/>
        ...
        <RailPerformanceByMode chartData={vrmPerVrhBymode} axisLabel={"Miles Per Hour"}/>
        ...
        <RailPerformanceByMode chartData={uptPerVrmBymode} axisLabel={"Passengers / Veh. Mile"}/>
        <PerformanceByService chartData={uptPerVrmByService} axisLabel={"Passengers / Veh. Mile"}/>
        <br/>
        <h2>Passengers per Service Hour</h2>
        <UptPerVrh chartData={uptPerVrh} axisLabel={"Passengers / Veh. Mile"}/>
        <RailPerformanceByMode chartData={uptPerVrhBymode} axisLabel={"Passengers / Veh. Mile"}/>
        <PerformanceByService chartData={uptPerVrhByService} axisLabel={"Passengers / Veh. Mile"}/>
        <br/>
        <h2>Passenger Miles per Vehicle Mile</h2>
        <PmtPerVrm chartData={pmtPerVrm} axisLabel={"Pass. Miles / Veh. Mile"}/>
        <RailPerformanceByMode chartData={pmtPerVrmBymode} axisLabel={"Pass. Miles / Veh. Mile"}/>
        ...
        <RailPerformanceByMode chartData={pmtPerVrhBymode} axisLabel={"Pass. Miles / Veh. Hour"}/>
