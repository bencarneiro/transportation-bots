...
function AllPerformance(props) {
  ...
  React.useEffect(() => {
    if (props.params) {
      ...
      // axios.get(`/cost_per_vrh_by_mode_type/?t=t${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`/cost_per_vrm_by_mode_type/?t=t${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`/frr_by_mode_type/?t=t${props.params}`)
      .then(response => setFrrByModeType(response.data.data))
      axios.get(`/vrm_per_vrh_by_mode_type/?t=t${props.params}`)
      .then(response => setVrmPerVrhByModeType(response.data.data))
      axios.get(`/upt_per_vrh_by_mode_type/?t=t${props.params}`)
      .then(response => setUptPerVrhByModeType(response.data.data))
      axios.get(`/upt_per_vrm_by_mode_type/?t=t${props.params}`)
      .then(response => setUptPerVrmByModeType(response.data.data))
      axios.get(`/pmt_per_vrh_by_mode_type/?t=t${props.params}`)
      .then(response => setPmtPerVrhByModeType(response.data.data))
      axios.get(`/pmt_per_vrm_by_mode_type/?t=t${props.params}`)
      .then(response => setPmtPerVrmByModeType(response.data.data))
      axios.get(`/cost_per_upt_by_service/?t=t${props.params}`)
      .then(response => setCostPerUptByService(response.data.data))
      axios.get(`/cost_per_pmt_by_service/?t=t${props.params}`)
      .then(response => setCostPerPmtByService(response.data.data))
      // axios.get(`/cost_per_vrh_by_service/?t=t${props.params}`)
      // .then(response => setCostPerVrh(response.data.data))
      // axios.get(`/cost_per_vrm_by_service/?t=t${props.params}`)
      // .then(response => setCostPerVrm(response.data.data))
      axios.get(`/frr_by_service/?t=t${props.params}`)
      .then(response => setFrrByService(response.data.data))
      axios.get(`/vrm_per_vrh_by_service/?t=t${props.params}`)
      .then(response => setVrmPerVrhByService(response.data.data))
      axios.get(`/upt_per_vrh_by_service/?t=t${props.params}`)
      .then(response => setUptPerVrhByService(response.data.data))
      axios.get(`/upt_per_vrm_by_service/?t=t${props.params}`)
      .then(response => setUptPerVrmByService(response.data.data))
      axios.get(`/pmt_per_vrh_by_service/?t=t${props.params}`)
      .then(response => setPmtPerVrhByService(response.data.data))
      axios.get(`/pmt_per_vrm_by_service/?t=t${props.params}`)
